...
contract WenTokens {
     ...
     */
    function airdropETH(address[] calldata _recipients, uint256[] calldata _amounts) external payable {
        ...
        assembly {
            ...
            if iszero(eq(runningTotal, callvalue())) { revert(0, 0) }
        }
    }
     ...
     */
    function airdropERC20(address _token, address[] calldata _recipients, uint256[] calldata _amounts, uint256 _total)
        external
    {
